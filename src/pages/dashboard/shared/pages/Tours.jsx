...
//             page_size: Math.min(paginationModel.pageSize, 50), // respect max_page_size
//           },
//         });
//         setTours(res.data.results || res.data);
//         setRowCount(res.data.count || (res.data.results?.length ?? 0));
...
//             paginationModel={paginationModel}
//             onPaginationModelChange={setPaginationModel}
//             pageSizeOptions={[12, 15, 25, 50]} // safe options within DRF max_page_size
//             disableColumnFilter
//             disableColumnSelector
//             disableDensitySelector
//             slots={{
...
// src/pages/dashboard/common/tours/Tours.jsx
import React, { useEffect, useState, useMemo } from "react";
import {
  DataGrid,
  GridToolbarContainer,
...
export default function Tours() {
  ...
  useEffect(() => {
      ...
      try {
        const res = await axiosInstance.get(`${API_BASE}/tours/`, {
          params: {
            ...
            page_size: Math.min(paginationModel.pageSize, 50),
            search: searchText || undefined, // send search term to backend
          },
        });
    ...
    fetchTours();
  }, [paginationModel, searchText, API_BASE]);
